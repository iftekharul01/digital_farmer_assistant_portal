...
<head>
    ...
    url('https://images.pexels.com/photos/539282/pexels-photo-539282.jpeg') center/cover no-repeat;
            min-height: 60vh;
            color: white;
            padding: 80px 0;
            text-align: center;
...
<main class="main-content">
    <section class="about-hero-section animate__animated animate__fadeIn" data-aos="fade-down" data-aos-duration="1000">
        <div class="about-page-wrapper">
            <h1>Our Story: Cultivating Progress</h1>
            <p>
                Empowering farmers through technology and knowledge, we're dedicated to fostering a resilient and prosperous agricultural community. Discover our journey, values, and the team making it happen.
            </p>
        </div>
    </section>
    ...
    <div class="about-page-wrapper"> <section class="section-container animate__animated animate__fadeInUp" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="section-content">
                <p>
                    At Farmer Portal, we're driven by a deep understanding of the challenges farmers face daily. From unpredictable weather to volatile markets and stubborn crop diseases, modern agriculture demands resilience and quick adaptation. Our motivation stems from a fundamental belief: **technology can be a powerful ally for every farmer,** no matter their scale or location. We're here to bridge information gaps, providing timely, accurate, and actionable insights to cultivate sustainable and profitable practices. We envision a future where innovation empowers every farmer to thrive.
                </p>
                <p>
                    This isn't just about data; it's about dignity, prosperity, and food security for all. We're passionate about supporting the backbone of our economy and ensuring a brighter future for generations of farmers.
                </p>
            </div>
        </section>
        ...
        <section class="mission-vision-section animate__animated animate__fadeInUp" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="mission-vision-grid">
                <div class="mission-vision-card" data-aos="zoom-in-up" data-aos-delay="400">
                    ...
                    <h4>Our Mission</h4>
                    <p>To provide cutting-edge digital tools and comprehensive knowledge resources that empower farmers to make informed decisions, optimize yields, and achieve economic sustainability in an ever-evolving agricultural landscape.</p>
                </div>
                <div class="mission-vision-card" data-aos="zoom-in-up" data-aos-delay="500">
                    <i class="fas fa-globe-asia"></i>
                    <h4>Our Vision</h4>
                    <p>To cultivate a globally connected and resilient farming community, where every farmer has equitable access to technology, expertise, and market opportunities, ensuring a prosperous and sustainable future for agriculture worldwide.</p>
                </div>
            </div>
        </section>
