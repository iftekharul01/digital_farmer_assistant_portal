...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <h2 class="form-title">টিউটোরিয়ালের তথ্য প্রদান করুন</h2>
            ...
            <form action="{{ route('admin.tutorials.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="icon" id="selected-icon" value="{{ old('icon', 'fas fa-seedling') }}">
                    
                    <div class="icon-selector">
                        <div class="icon-option selected" data-icon="fas fa-seedling">
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        placeholder="ভিডিওর বিবরণ">{{ old('video_description') }}</textarea>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save"></i> টিউটোরিয়াল সংরক্ষণ করুন
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set initial selection from old value
            const oldIcon = selectedIconInput.value;
            iconOptions.forEach(option => {
                if (option.dataset.icon === oldIcon) {
